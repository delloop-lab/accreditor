...
<body>
    ...
    `).join('')}
           ...
           <div class="footer">
                         <p>This report was generated by ICF Log Beta V0.9.500 - Professional Coaching Log & CPD Tracker</p>
          ...
          {sessions.slice(0, 5).map((session, index) => (
            ...
            >
              ...
              <div className="text-right">
                ...
                <div className="text-xs text-gray-500">
                  {formatNumberForDisplay(session.payment_amount, { country: profile?.country || 'US', currency: profile?.currency || 'USD' }, { style: 'currency' })}
                </div>
              </div>
            </div>
          ))}
