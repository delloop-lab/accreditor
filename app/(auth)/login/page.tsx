          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 pr-12 border border-gray-400 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                value={password}
