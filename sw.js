...
// next-pwa automatically injects the manifest when using swSrc
// precacheAndRoute() without arguments will use the injected manifest
try {
  // precacheAndRoute will automatically use the injected manifest
  precacheAndRoute();
