...
// next-pwa uses injectManifest mode which requires self.__WB_MANIFEST to appear exactly once
// Workbox will replace this placeholder with the actual manifest during build
try {
