...
// next-pwa automatically injects self.__WB_MANIFEST, so we just call precacheAndRoute()
// without arguments to use the injected manifest
try {
  // precacheAndRoute() will automatically use self.__WB_MANIFEST injected by next-pwa
  precacheAndRoute();
