...
// next-pwa automatically injects self.__WB_MANIFEST when using swSrc
// We must explicitly pass it to precacheAndRoute to avoid duplication
try {
  // Use the injected manifest from next-pwa
