-- Delete user geoge@yopmail.com from all tables
-- Run this in your Supabase SQL Editor

-- Step 1: First, let's see what user_id we're dealing with
SELECT user_id, name, email 
FROM profiles 
WHERE email = 'geoge@yopmail.com';
...
SELECT COUNT(*) as remaining_profiles FROM profiles WHERE email = 'geoge@yopmail.com'; 